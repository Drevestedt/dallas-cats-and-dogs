...
<p>I've used the <a href="https://validator.w3.org">HTML W3C Validator</a> to validate all of my HTML files.</p>
...
<p>I've used the <a href="https://jigsaw.w3.org/css-validator/">CSS W3C Validator</a> to validate all of my CSS files.</p>
...
<p>I've tested my deployed project on multiple browsers to check for compatibility issues.</p>
...
<p>I've tested my deployed project on multiple devices to check for responsivness issues.</p>

<table>
<tr>
    <td align="center" valign="top">
      <h4>Device</h4>
      <p>Mobile (Dev Tools)</p>
    </td>
     <td align="center" valign="top">
      <h4>Screenshot</h4>
